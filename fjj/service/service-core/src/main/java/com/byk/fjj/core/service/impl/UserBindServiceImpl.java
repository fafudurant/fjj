...
import com.byk.fjj.core.mapper.UserBindMapper;
...
public class UserBindServiceImpl extends ServiceImpl<UserBindMapper, UserBind> implements UserBindService {
    ...
    public String commitBindUser(UserBindVO userBindVO, Long userId) {
        ...
        paramMap.put("returnUrl", ZjtgConst.USERBIND_RETURN_URL);
        paramMap.put("notifyUrl", ZjtgConst.USERBIND_NOTIFY_URL);
        paramMap.put("timestamp", RequestHelper.getTimestamp());
        paramMap.put("sign", RequestHelper.getSign(paramMap));
        //生成动态表单字符串
        String formStr = FormHelper.buildForm(ZjtgConst.USERBIND_URL,paramMap);
        return formStr;
    }
