...
import com.byk.fjj.core.mapper.*;
...
public class LendReturnServiceImpl extends ServiceImpl<LendReturnMapper, LendReturn> implements LendReturnService {
    ...
    public String commitReturn(Long lendReturnId, Long userId) {
        ...
        paramMap.put("notifyUrl", ZjtgConst.BORROW_RETURN_NOTIFY_URL);
        paramMap.put("returnUrl", ZjtgConst.BORROW_RETURN_RETURN_URL);
        paramMap.put("timestamp", RequestHelper.getTimestamp());
        String sign = RequestHelper.getSign(paramMap);
        paramMap.put("sign", sign);
        //构建自动提交表单
        String formStr = FormHelper.buildForm(ZjtgConst.BORROW_RETURN_URL, paramMap);
        return formStr;
    }
